...
class TempleInterior(Interior):
    ...
    def _create_high_priestess(self) -> NPC:
        ...
        dialogues = [
            {"speaker": "Верховная жрица Иссара",
             "text": "Добро пожаловать в храм Авэлин, богини рассвета, "
                     "исцеления и вечного света.",
             "portrait_color": (200, 170, 230)},
            {"speaker": "Верховная жрица Иссара",
             "text": "Авэлин хранит равновесие между светом и тьмой. "
                     "Без неё мир давно бы погиб во мраке.",
             "portrait_color": (200, 170, 230)},
            {"speaker": "Верховная жрица Иссара",
             "text": "Я чувствую в тебе искру... Ты пришёл из-за Завесы, "
                     "не так ли? Немногие выживают в том путешествии.",
             "portrait_color": (200, 170, 230)},
            {"speaker": "Верховная жрица Иссара",
             "text": "Если хочешь получить благословение Авэлин — "
                     "принеси три лунных цветка. Они растут в Туманном лесу "
                     "только в полнолуние.",
             "portrait_color": (200, 170, 230)},
            {"speaker": "Верховная жрица Иссара",
             "text": "А пока — отдохни. Сёстры позаботятся о тебе. "
                     "Свет богини да пребудет с тобой.",
             "portrait_color": (200, 170, 230)},
        ]
    ...
    def _create_elder_sister(self, name: str, special_text: str) -> NPC:
        ...
        dialogues = [
            ...
            {"speaker": name,
             ...
             "portrait_color": (180, 155, 210)},
            {"speaker": name,
             "text": "Если тебе нужно исцеление — оставь подношение на алтаре, "
                     "и богиня услышит твою молитву.",
             "portrait_color": (180, 155, 210)},
        ]
    ...
    def _create_priestess(self, name: str) -> NPC:
        ...
        dialogues = [
            {"speaker": name,
             "text": "Этот алтарь посвящён одному из ликов богини. "
                     "Авэлин многолика, как и сама жизнь.",
    ...
    def _create_lore_keeper(self) -> NPC:
        ...
        dialogues = [
            {"speaker": "Хранительница Тереза",
             "text": "Тише... Это библиотека священных текстов. "
                     "Здесь хранятся молитвы и пророчества тысячелетней давности.",
             "portrait_color": (150, 130, 170)},
            {"speaker": "Хранительница Тереза",
             "text": "Если ищешь знания о Древних — я могу помочь. "
                     "Но некоторые книги запечатаны не без причины...",
             "portrait_color": (150, 130, 170)},
            {"speaker": "Хранительница Тереза",
             "text": "Есть одно пророчество... о том, кто придёт из-за Завесы. "
                     "Хочешь — прочту?",
             "portrait_color": (150, 130, 170)},
        ]
    ...
    def _create_baptizer(self) -> NPC:
        ...
        dialogues = [
            {"speaker": "Сестра Агата",
             "text": "Священная купель очищает душу от скверны. "
                     "Многие приходят сюда после встречи с тьмой.",
             "portrait_color": (160, 145, 190)},
            {"speaker": "Сестра Агата",
             "text": "Вода в купели благословлена самой Авэлин. "
                     "Она снимает проклятия и исцеляет раны духа.",
             "portrait_color": (160, 145, 190)},
            {"speaker": "Сестра Агата",
             "text": "Хочешь пройти обряд очищения? Это займёт немного времени, "
                     "но ты почувствуешь себя обновлённым.",
             "portrait_color": (160, 145, 190)},
        ]
